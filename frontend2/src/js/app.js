$(function () {
  ...
  function adjustBanner(){
    ...
    if (windowWidth < 900) {
      $("#banner1").attr(
        "src",
        "/images/banner/banner-0-m.jpg"
        );
      $("#banner2").attr(
        "src",
        "/images/banner/banner-1-m.jpg"
         );
      $("#banner3").attr(
        "src",
        "/images/banner/banner-2-m.jpg"
        );
      $("#banner4").attr(
         "src",
         "/images/banner/banner-3-m.jpg"
        );
    ...
    if (windowWidth > 0) {
      if ($(document).scrollTop() >= 100) {
        ...
        if (
          ...
          // $(".company-logo img").attr("src", "/images/logos/logo.png");
        } else {
          // $(".company-logo img").attr(
          //   "src",
          //   "/images/logos/black-logo.png"
      ...
      // $(".company-logo img").attr("src", "/images/logos/black-logo.png");
    }
  }
  ...
  $(document).ready(function () {
    $(".player").mb_YTPlayer({
      mobileFallbackImage: "images/banner/banner-1.jpg",
    });
  });
